 ...
 */
$mailTo     = 'bugrahan_ozdemir@outlook.com';

/**
 * Set the message that will be shown on success
 */
$successMsg = 'Bana ulaştığınız için teşekkürler! En kısa sürede dönüş sağlayacağım.';

/**
 * Set the message that will be shown if not all fields are filled
 */
$fillMsg    = 'Lütfen tüm alanları doldurun!';

/**
 * Set the message that will be shown on error
 */
$errorMsg   = 'Sanırım bir sorun oldu. Lütfen daha sonra tekrar deneyin.';
